                      ...
                      child: Container(
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              String service;
                              if(controller.orders[index].servicetype == 'instant'){
                                service = 'Instant video / audio meeting';
                                print(service);
                              }else if(controller.orders[index].servicetype == 'document'){
                                if(controller.orders[index].document!.documenttype == 'DocumentType.NotUrgent'){
                                  service = 'Non urgent documents translation';
                                }else{
                                  service = 'Urgent documents translation';
                                }
                                print(controller.orders[index].document!.documenttype);
                              }else{
                                if(controller.orders[index].scheduletype == 'audio/video'){
